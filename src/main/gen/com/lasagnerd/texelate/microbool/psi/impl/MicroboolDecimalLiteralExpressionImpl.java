...
public class MicroboolDecimalLiteralExpressionImpl extends MicroboolExpressionImpl implements MicroboolDecimalLiteralExpression {

  public MicroboolDecimalLiteralExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MicroboolVisitor visitor) {
    visitor.visitDecimalLiteralExpression(this);
  }
  ...
  public PsiElement getDecimalLiteral() {
    return findNotNullChildByType(DECIMAL_LITERAL);
  }
