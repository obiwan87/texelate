...
public class MicroboolBoolLiteralExpressionImpl extends MicroboolExpressionImpl implements MicroboolBoolLiteralExpression {

  public MicroboolBoolLiteralExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
