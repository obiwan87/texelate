...
public abstract class MicroboolBinaryOperatorImpl extends ASTWrapperPsiElement implements MicroboolBinaryOperator {

  public MicroboolBinaryOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
