...
public class MicroboolBinaryOperatorInequalityImpl extends MicroboolBinaryOperatorImpl implements MicroboolBinaryOperatorInequality {

  public MicroboolBinaryOperatorInequalityImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MicroboolVisitor visitor) {
    visitor.visitBinaryOperatorInequality(this);
  }
