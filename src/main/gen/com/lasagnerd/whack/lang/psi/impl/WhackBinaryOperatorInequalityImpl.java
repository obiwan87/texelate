...
public class WhackBinaryOperatorInequalityImpl extends WhackBinaryOperatorImpl implements WhackBinaryOperatorInequality {

  public WhackBinaryOperatorInequalityImpl(@NotNull ASTNode node) {
    super(node);
  }
